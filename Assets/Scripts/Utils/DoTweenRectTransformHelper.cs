...
[ExecuteInEditMode]
public class DoTweenRectTransformHelper : TweenEditor {
    ...
    void onPlayTween(Transform Moveto) {
        this.GetComponent<RectTransform>().DOAnchorPos3D(Moveto.GetComponent<RectTransform>().anchoredPosition3D, this.tweenTime).SetAs(tParms);
